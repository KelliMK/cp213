...
public class RTSameView extends JPanel {
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(final ActionEvent evt) {
			if (this.direction == 0) {
				RTSameView.this.model.setBase((RTSameView.this.model.getBase() + RTSameView.this.model.getHeight()) / 2);
				RTSameView.this.model.setHeight(RTSameView.this.model.getBase());
			} else {
