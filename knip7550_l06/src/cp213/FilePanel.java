...
public class FilePanel extends JPanel {
	...
	// ---------------------------------------------------------------------
	/**
	 * An inner class that uses an ActionListener to access <code>openButton</code>.
	 * It displays the result of the division when pressed and catches any input and
	 * division errors.
	 */
	private class OpenListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent evt) {
			try {
				...
				JOptionPane.showMessageDialog(null, "File not found: " + FilePanel.this.fileNameField.getText(),
